...
const EditarLunaDeMiel = () => {
  ...
  const { updateLunaMiel, loading } = useLunaMielServices()
  ...
  useEffect(() => {
    ...
    setDescripcionLarga(objetoLuna?.descripcionLargaLuna)
  }, [])
  ...
  return (
    <div className="p-5 py-10 bg-white shadow md:rounded md:p-10">
